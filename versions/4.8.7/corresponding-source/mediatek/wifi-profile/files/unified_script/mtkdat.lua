...
local country_region_map_5g = {
    AL = 0, DZ = 0, AU = 0, BH = 0, BY = 0, CA = 0, CL = 0, CN = 0, CO = 0, CR = 0, DO = 0, EC = 0, SV = 0, GT = 0, HN = 0, HK = 0, IN = 0, IL = 0, JO = 0, KZ = 0, KW = 0,
    ...
    KP = 5, KR = 5, UY = 5, VE = 5, JP = 12, US = 13
}
