...
This guide applies to the source release for GL-MT3600BE firmware 4.8.7.

## Release mapping

The source tree is mapped to the following published firmware image:

```text
Version:   4.8.7 release2
Image:     mt3600be-4.8.7_release2-951-0415-1776265293.bin
SHA256:    43aed4181b446a1b8846333b20f6bba6dcf436694a0bb17ea56202542c1d879f
Download:  https://fw.gl-inet.com/firmware/mt3600be/release/mt3600be-4.8.7_release2-951-0415-1776265293.bin
```

`configs/gl-mt3600be-baseline.config` records the configuration captured from
the completed internal build tree. It includes package selections that are not
...
source used by those payloads is retained under
`corresponding-source/mediatek`. GL.iNet proprietary application and web UI
