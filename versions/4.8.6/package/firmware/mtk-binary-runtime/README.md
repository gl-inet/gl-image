...
Hostapd, wpad, hostapd-utils and wpa-cli are installed from the bundled IPKs
by `mtk-wifi-runtime`. The supplied build configurations do not select their
...
including hostapd inputs in the Wi-Fi group; they are not manifests of
