...
The Wi-Fi runtime installs the bundled `hostapd-common`, `hostapd-utils`,
`wpa-cli` and `wpad-openssl` IPKs. Their separate source packages are not
selected in the public build configurations.
